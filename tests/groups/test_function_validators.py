...
def test_equal_ids_validator_ids_match(mock_group_context, mock_function, random_string):
...
def test_equal_ids_validator_ids_mismatch(mock_group_context, mock_function, random_string):
    validator = EqualIdsValidator()
    mock_group_context.id = random_string
...
def test_unique_signatures_validator_signature_not_exists(mock_group_context, mock_function, random_string):
...
def test_unique_signatures_validator_signature_exists(mock_group_context, mock_function, random_string):
    validator = UniqueSignaturesValidator()
