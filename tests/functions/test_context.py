...
@patch('pyloadover.functions.context.get_underlying_callable', autospec=True)
def test_signature_assignment_uses_underlying_callable(mock_get_underlying_callable: MagicMock,
...
@patch('inspect.signature', autospec=True)
@patch('pyloadover.functions.context.get_underlying_callable', autospec=True)
def test_signature_assignment_uses_callable(mock_get_underlying_callable: MagicMock,
                                            mock_signature: MagicMock,
                                            mock_callable):
